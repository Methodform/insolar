              ...
              {(() => {
                ...
                return <>
                  ...
                  <Flex align="center" justify="between" style={{ marginBottom: 2 }}>
                    <Text style={{ fontSize: 12, fontWeight: 500, whiteSpace: 'nowrap' }}><span style={{ color: '#e08a1e' }}>Восход</span>{!mobile && ' ' + hhmm(sunRise)}</Text>
                    <Text style={{ fontSize: 12, fontWeight: 500, whiteSpace: 'nowrap' }}>{hhmm(cur)}</Text>
                    <Text style={{ fontSize: 12, fontWeight: 500, whiteSpace: 'nowrap' }}><span style={{ color: '#e08a1e' }}>Закат</span>{!mobile && ' ' + hhmm(sunSet)}</Text>
                  </Flex>
